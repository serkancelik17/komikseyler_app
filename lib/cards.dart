...
class _DraggableCardState extends State<DraggableCard> with TickerProviderStateMixin {
  ...
  Offset _chooseRandomDragStart() {
    ...
    final cardTopLeft = (cardContex.findRenderObject() as RenderBox).localToGlobal(const Offset(0.0, 0.0));
    final dragStartY = widget.screenHeight * (new Random().nextDouble() < 0.5 ? 0.25 : 0.75) + cardTopLeft.dy;
...
class _ProfileCardState extends State<ProfileCard> {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: new BoxDecoration(borderRadius: new BorderRadius.circular(10.0), boxShadow: [
        new BoxShadow(
